...
def framerestyle(pipe_ep):
    ...
    mtx=np.array([[1.83633804e+03, 0.00000000e+00, 1.92099278e+03],[0.00000000e+00, 1.83633804e+03, 1.11106976e+03],[0.00000000e+00, 0.00000000e+00, 1.00000000e+00]])
    dist=np.array([[ 0.03632686], [-0.03389619], [ 0.00217811], [ 0.00179351], [-0.00922097], [-0.02943148], [-0.00019331], [-0.01268895], [ 0.        ], [ 0.        ], [ 0.        ], [ 0.        ], [ 0.        ], [ 0.        ]])
    img_dist=cv2.undistort(resized,mtx,dist,None)
    ...
    if np.all(ids != None):
        ...
        for i in range(0, ids.size):
            ...
            aruco.drawAxis(img_dist, mtx, dist, rvec[i], tvec[i], 0.1)

        # draw a square around the markers
        aruco.drawDetectedMarkers(img_dist, corners)
        ...
        cv2.putText(img_dist, "Id: " + strg, (0,64), font, 1, (0,255,0),2,cv2.LINE_AA)


    else:
        # code to show 'No Ids' when no markers are found
        cv2.putText(img_dist, "No Ids", (0,64), font, 1, (0,255,0),2,cv2.LINE_AA)

    # display the resulting frame
    cv2.imshow('frame',img_dist)
